...
if marks < 25:
    ...
    print("A")
print()
print("--- Question:Ask user to enter age, gender ( M or F ), marital status ( Y or N ) and then using following rules print their place of service.---")
#if employee is female, then she will work only in urban areas.

#if Emlployee is a male and age is in between 20 to 40 then he may work in anywhere
